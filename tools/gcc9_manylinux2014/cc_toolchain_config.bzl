...
def _impl(ctx):
    tool_paths = [
        ...
        tool_path(name = "gcc", path = "/opt/rh/devtoolset-9/root/usr/bin/gcc"),
    ...
    cxx_builtin_include_directories = [
        ...
        "/opt/rh/devtoolset-9/root/usr/lib/gcc/x86_64-redhat-linux/9/include-fixed",
        "/opt/rh/devtoolset-9/root/usr/include",
        "/opt/rh/devtoolset-9/root/usr/include/c++/9",
        "/opt/rh/devtoolset-9/root/usr/include/c++/9/x86_64-pc-linux-gnu",
        "/opt/rh/devtoolset-9/root/usr/include/c++/9/backward",
        "/usr/include",
        "/usr/local/include"
    ]
    ...
    link_flags = [
        ...
        "-Wl,-no-as-needed",
        "-Wl,-z,relro,-z,now",
        "-B/opt/rh/devtoolset-9/root/usr/bin",
        "-pass-exit-codes",
        "-lstdc++",
        "-lm",
    ]
    ...
    opt_link_flags = [
        # gc-sections doesn't seem to work:
        # /lib/../lib64/libc.a(____longjmp_chk.o)(.note.stapsdt+0x14): error: relocation refers to local symbol "" [1], which is defined in a discarded section
        # /lib/../lib64/libc.a(____longjmp_chk.o)(.note.stapsdt+0x64): error: relocation refers to local symbol "" [1], which is defined in a discarded section
        # "-Wl,--gc-sections",
    ]
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        compiler = "/opt/rh/devtoolset-9/root/usr/bin/gcc",
        abi_version = "gcc",
