...
/* Flush any pending data in the zip write buffer */

extern int ZEXPORT zipPretendWriteInZip64(zipFile file, uint64_t compressed_size);
/* Pretend we just wrote compressed_size bytes inside the zip, when they were
   really added externally to the zip library. */
